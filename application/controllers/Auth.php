...
class Auth extends CI_Controller {
    ...
    {  
            ...
            $data['paket'] = $this->paket->getInfo('id,id_fasilitas');
            ...
            $data['jenis_paket'] = $this->paket->getWhere('*',$where);
        ...
        public function sigup()
        {
            ...
            $config = Array(  
                    ...
                    'smtp_port' => 465,  
                    'smtp_user' => 'cobaakun033@gmail.com',   //email google
                    'smtp_pass' => 'Cobaakun123',   //passsword google
                    'mailtype' => 'html',  
                    'charset' => 'iso-8859-1'  
                    );  
                    ...
                    $this->email->cc('tharsiskazurik@gmail.com');   //email sesuaikan
        ...
        {                                  
            ...
            if ($this->form_validation->run() == FALSE) {  
                ...
                redirect(site_url().'auth/pemesanan/');
               ...
               // echo $message; //send this through mail
                 ...
                 $config = Array(  
                   ...
                   'smtp_user' => 'cobaakun033@gmail.com',   //email google
                    ...
                    $this->email->from(($this->input->post('email',TRUE)), ($this->input->post('nama_depan',TRUE)));  
                    $this->email->to($this->input->post('email',TRUE));  
                    $this->email->cc('tharsiskazuri@gmail.com');   //sesuaikan
