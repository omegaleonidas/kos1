...
<head>
  ...
  <link href='<?=base_url('assets/')?>https://fonts.googleapis.com/css?family=Droid+Serif:400,700,400italic,700italic' rel='stylesheet'
    type='text/css'>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="<?=base_url('')?>">Kost</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#macamKos"> jenis kamar</a>
          </li>
          <li class="nav-item">
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        <div class="intro-lead-in">Selamat datang di Kost kami</div>
        <div class="intro-heading text-uppercase">lagi maintanance!</div>
        <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="Auth/sigup">Register</a>
      </div>
    </div>
  </header>